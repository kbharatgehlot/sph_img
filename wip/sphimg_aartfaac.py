...
def do_inversion_gridded(config, result_dir):
    ...
    for i in range(len(freqs)):
        ...
        plot_pool.apply_async(plot_rec_power_sepctra, (ll2, mm2, alm_rec, lamb, 
    ...
    if len(alms_rec) > 1:
         plot_2d_power_spectra(ll2, mm2, alms_rec, freqs, config, os.path.join(result_dir, 'power_spectra_2d.pdf'),vmin=1e-3, vmax=1e-1)
